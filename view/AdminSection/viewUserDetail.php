...
?>
        <div class="table-section ">
                <table class="table table-striped  table-bordered table-responsive-sm table-responsive-md table-responsive-lg table-dark table-image">
                    ...
                    <tr>
                        ...
                        <th style="vertical-align:middle;text-align:center;" scope="col">Email</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Mobile</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">Account Created On</th>
                        <th style="vertical-align:middle;text-align:center;" scope="col">is Active</th>
                    ...
                    <?php
                      // include '../../constants/constants.php';
                      include '../../model/viewAllUsers.php';
                      while ($row = mysqli_fetch_array($conSql)) {
                        ...
                        if(str_starts_with($row[7],"https"))
                        {
                        ...
                        if($row[5]==1){
                          echo "      <td style='vertical-align:middle;text-align:center;'><input type='checkbox' style='zoom:2;' checked readonly onclick='return false'/></td>";
                        }
                        else{
                          echo "      <td style='vertical-align:middle;text-align:center;'><input type='checkbox' style='zoom:2;' readonly onclick='return false'/></td>";
                        ...
                        if($row[5]==1)
                        {
                            ...
                            <a href='../../model/DeactivateUser.php?userId=".$row[0]."' class='btn btn-danger my-btn'>Deactivate</a> 
                            <a href='userHistory.php?userId=".$row[0]."&userName=".$row[1]."' class='btn btn-success my-btn'>View History</a>
                          </td>";
                        }
                        else{
                            echo "      <td style='vertical-align:middle;text-align:center;'>
                            <a href='../../model/ActivateUser.php?userId=".$row[0]."' class='btn btn-warning my-btn'>Activate</a> 
                            <a href='userHistory.php?userId=".$row[0]."&userName=".$row[1]."' class='btn btn-success my-btn'>View History</a>
                          </td>";
                        }
      ...
      <div class="topFooter">
        ...
        <div class="footer-nav">
          <li class="nav__item" onClick="redirectFunction()"><a class="nav__link" >Home</a></li>
